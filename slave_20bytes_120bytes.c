  ...
  while (1) {
    ...
    switch (BGLIB_MSG_ID(evt->header)) {
     ...
     case gecko_evt_gatt_server_attribute_value_id:
    	 ...
    	 if(isNotify == 1){
 gecko_cmd_gatt_server_send_characteristic_notification(evt->data.evt_gatt_server_attribute_value.connection,//0xff,
    	        gattdb_custom_characteristic,
    	 	   evt->data.evt_gatt_server_attribute_value.value.len,//20,
